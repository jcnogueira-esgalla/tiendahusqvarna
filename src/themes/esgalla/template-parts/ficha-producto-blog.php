...
?> data-slick-index="<?php echo $position;?>"  href="<?php echo get_permalink( $producto->get_id() ) ?>" class="ficha-producto ficha-producto-blog d-flex flex-column justify-content-between text-decoration-none<?php echo ' '.$args['class'] ?>" data-id="<?php echo $producto->get_id() ?>">
