...
<div class="fila mw-2">
    <div class="col mb-30 p-20 fs-1-2 tt-u ">
        <div class="col-contain fs-1-2 tt-u ta-c c-b bgc-error">
        ...
        <div class="mt-20"><a class="button wc-backward" href="<?php echo esc_url( wc_get_page_permalink( 'cart' ) ); ?>"><?php esc_html_e( 'Return to cart', 'woocommerce' ); ?></a></div>
    </div>
</div>
